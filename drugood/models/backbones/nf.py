...
from dgllife.model import SumAndMax
...
class NF(nn.Module):
    ...
    def forward(self, input):
        ...
        input_self = dgl.add_self_loop(input)
        node_feats = input.ndata["x"]
        deg = None
        max_deg = None
        deg_membership = None
        for gnn in self.gnn_layers:
            node_feats, deg, max_deg, deg_membership = gnn(input, input_self, node_feats, deg, max_deg, deg_membership)
