...
from drugood.core.visualization import imshow_infos

# TODO import `auto_fp16` from mmcv and delete them drugood
try:
    from mmcv.runner import auto_fp16
except ImportError:
    warnings.warn('auto_fp16 drugood will be deprecated.'
                  'Please install mmcv>=1.1.4.')
    from drugood.core import auto_fp16
